...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(591, 363)
        self.groupBox = QtWidgets.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(290, 10, 291, 261))
        ...
        self.savepath.setGeometry(QtCore.QRect(10, 210, 241, 31))
        ...
        self.dir_choose.setGeometry(QtCore.QRect(250, 210, 31, 31))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 10, 271, 141))
        ...
        self.startshift.setGeometry(QtCore.QRect(140, 20, 121, 31))
        ...
        self.endshift.setGeometry(QtCore.QRect(140, 60, 121, 31))
        ...
        self.interval.setGeometry(QtCore.QRect(140, 100, 121, 31))
        ...
        self.save_.setGeometry(QtCore.QRect(320, 300, 93, 41))
        self.save_.setObjectName("save_")
        self.cancel_ = QtWidgets.QPushButton(Dialog)
        self.cancel_.setGeometry(QtCore.QRect(460, 300, 93, 41))
        self.cancel_.setObjectName("cancel_")
        self.groupBox_4 = QtWidgets.QGroupBox(Dialog)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 150, 271, 211))
        self.groupBox_4.setObjectName("groupBox_4")
        self.number = QtWidgets.QSpinBox(self.groupBox_4)
        self.number.setGeometry(QtCore.QRect(140, 20, 121, 31))
        ...
        self.noise2.setGeometry(QtCore.QRect(200, 100, 61, 31))
        ...
        self.noise1.setGeometry(QtCore.QRect(140, 100, 61, 31))
        ...
        self.label_12.setGeometry(QtCore.QRect(10, 50, 111, 51))
        self.label_12.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.label_12.setWordWrap(True)
        self.label_12.setObjectName("label_12")
        self.num_components = QtWidgets.QSpinBox(self.groupBox_4)
        self.num_components.setGeometry(QtCore.QRect(140, 60, 121, 31))
        self.num_components.setMinimum(2)
        self.num_components.setMaximum(999999)
        self.num_components.setProperty("value", 3)
        self.num_components.setObjectName("num_components")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_12.setText(_translate("Dialog", "Max Number of Components"))