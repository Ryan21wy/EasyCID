...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        dialog.resize(389, 453)
        self.OK = QtWidgets.QPushButton(dialog)
        self.OK.setEnabled(True)
        self.OK.setGeometry(QtCore.QRect(150, 410, 93, 28))
        self.OK.setObjectName("OK")
        self.groupBox_2 = QtWidgets.QGroupBox(dialog)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 180, 371, 221))
        ...
        self.sb_maxiter.setProperty("value", 10)
        ...
        self.comboBox.setGeometry(QtCore.QRect(220, 20, 111, 31))
        ...
        self.EN_iter.setGeometry(QtCore.QRect(220, 130, 111, 22))
        ...
        self.label_6.setGeometry(QtCore.QRect(40, 130, 111, 21))
        self.label_6.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.groupBox)
        self.label_7.setGeometry(QtCore.QRect(40, 100, 111, 21))
        self.label_7.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_7.setAlignment(QtCore.Qt.AlignCenter)
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.groupBox)
        self.label_8.setGeometry(QtCore.QRect(10, 60, 191, 31))
        ...
        self.EN_ratio.setGeometry(QtCore.QRect(220, 100, 111, 22))
    ...
    def retranslateUi(self, dialog):
        ...
        dialog.setWindowTitle(_translate("dialog", "Prediction Parameter Setting"))
        self.OK.setText(_translate("dialog", "OK"))
        self.groupBox_2.setTitle(_translate("dialog", "Pre-Processing"))
        self.checkBox.setText(_translate("dialog", "Subtract Baseline -- airPLS"))
        self.checkBox_2.setText(_translate("dialog", "smooth -- Whittaker"))
        ...
        self.groupBox.setTitle(_translate("dialog", "Prediction"))
